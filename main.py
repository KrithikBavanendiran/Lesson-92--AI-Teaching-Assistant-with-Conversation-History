...
def setup_ui():
    st.set_page_config(page_title="AI Teachong Assistant", layout="centered")
    st.title("AI Teaching Assistant")
    st.write("Ask me anything about various subjects and I'll provide an inshightful answer.")
